...
b = b[idxs] # vector
n3g2, n2g2, n1g2 = n3*inc3, n2*inc2, n1*inc1
mat3d = np.zeros([n3g2, n2g2, n1g2], np.float32)
...
for mode, itr, iper in zip(idxs[0], idxs[1], idxs[2]):
    ...
    mat3d *= 0.0
    mat3d[i3, i2, :n1g] = sensmat[mode, iper, itr, :]
    arr3d = mat3d[:n3g2, :n2g2, :n1g2]
    mat3dblk = arr3d.reshape(n3, inc3, n2, inc2, n1, inc1).sum(axis=(1, 3, 5))
    #mat3dblk = gaussian_filter(mat3dblk, sigma=sigmas, mode='nearest')
    cscmat = sparse.csc_matrix(mat3dblk.flatten())
    res.append(cscmat)
