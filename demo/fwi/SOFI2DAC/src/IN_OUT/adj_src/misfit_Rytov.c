...
/*----------------------------------------------------------------
 *   Calculate adjoint source based on Rytov approximation                                  
 *---------------------------------------------------------------*/
/*
@inproceedings{feng2014wave,
  title={Wave-equation based travel-time tomography for first arrival},
  author={Feng*, Bo and Wang, Huazhong and Li, Hui},
  booktitle={Beijing 2014 International Geophysical Conference \& Exposition, Beijing, China, 21-24 April 2014},
  pages={743--746},
  year={2014},
...
//     V_integ(1, nlen, syn_win, syn_int);
    Nnorm = V_dotproduct(1, nlen, syn_win, syn_win);
...
//         coeff = lag/Nnorm;
//     }else{
        /* the adjoint source for calculating the Banana-doughnut kernel */
    coeff = 1.0/Nnorm;
//     }
