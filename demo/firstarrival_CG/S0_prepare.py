...
optim={
    ...
    'prjroot'               :'/home/tao/Nutstore_Files/works/seisplatform/mod_OPTIM/demo/firstarrival_CG/prj', #[IN] project path
    ...
    'percond'               :1,                         #[IN] preconditional operator
    'niter_inner_max'       :100,                       #[IN] maximum number of cg
