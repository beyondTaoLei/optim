...
Usage:
    ...
    python /home/tao/Nutstore_Files/works/seisplatform/mod_OPTIM/demo/firstarrival_CG/S1_optim_PLCG.py optim 1 5
"""
import os
import sys
import json
...
for iterc in range(iter_start, iter_end+1, 1):
    ...
    subjob=[
        ...
        '${py3} ' + os.path.join('${optimroot}', 'PLCG', 'init_PLCG.py')+' '+fdir+' '+str(iterc),
        '${py3} ' + os.path.join('${optimroot}', 'PLCG', 'descent_PLCG.py')+' '+fdir
        ]
