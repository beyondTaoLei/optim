...
##########################################
print('Usage:\n \t plot_mod.py optim model/inv/inv.vs \n')

fdir        =sys.argv[1] # optim
fnm         =sys.argv[2] # model/true/true.vp
foptim      =os.path.join(fdir,'optim.json')
optim       =eval(open(foptim).read())
nx0, ny0, nz0  =optim['nxyzfd']
ox0, oy0, oz0  =optim['oxyzfd']
dx0, dy0, dz0  =optim['dxyzfd']
tmp, nx, ny = nx0, ny0, nz0
tmp, dx, dy = dx0, dy0, dz0
tmp, ox, oy = ox0, oy0, oz0
vmin0       =3000.0
vmax0       =4500.0
...
ax.set_title('Vs model', fontsize=12)
ax.set_ylim([1.0e5, yvel[0]])
